...
const tabs = [
  { href: "/app", label: "Home", match: (p: string) => p === "/app" || p === "/app/", Icon: IconHome },
  { href: "/app/batches", label: "Batches", match: (p: string) => p.startsWith("/app/batches"), Icon: IconGrid },
  { href: "/app/payments", label: "Finance", match: (p: string) => p.startsWith("/app/payments") || p.startsWith("/app/ledger"), Icon: IconFinance },
  { href: "/app/students", label: "Students", match: (p: string) => p.startsWith("/app/students"), Icon: IconPeople },
  { href: "/app/more", label: "More", match: (p: string) => p.startsWith("/app/more"), Icon: IconMore },
] as const;
