...
export default function LoginPage() {
  return (
    <div className="relative flex min-h-svh flex-col overflow-hidden bg-[var(--app-bg)]">
      ...
      {/* 2. Abstract Geometric Rings (Orbital) */}
      ...
      <div className="relative z-10 flex flex-1 flex-col px-5 sm:px-10 pt-[calc(2.5rem+var(--safe-top))] pb-[calc(1.25rem+var(--safe-bottom))] sm:py-20">
        ...
        <div className="flex flex-1 flex-col items-center justify-center text-center">
          <div className="relative group">
            ...
            <div className="relative flex h-24 w-24 items-center justify-center rounded-[2.5rem] bg-[#0d0d0d] border border-white/10 shadow-2xl text-4xl font-black text-[var(--app-accent)]">
              B
            </div>
          </div>
